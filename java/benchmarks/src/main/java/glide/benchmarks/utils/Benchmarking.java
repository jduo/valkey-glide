                ...
                () -> {
                    var taskActionResults =
                            Map.of(
                                    ...
                                    ChosenAction.DEL, new ArrayList<Long>());
                    ...
                    while (true) {
                        ...
                        if (endTimeNanos > 0) {
                            // Duration-based: check if time is up
                            if (System.nanoTime() >= endTimeNanos) {
                                break;
                            }
                        } else {
                            // Iteration-based: check if iterations complete
                        ...
                        // Check if we've exceeded iterations (race condition protection)
