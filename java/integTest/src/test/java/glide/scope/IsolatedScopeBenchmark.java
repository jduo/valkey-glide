...
public class IsolatedScopeBenchmark {
    ...
    public void benchmarkWatchTransaction() throws Exception {
        ...
        for (int i = 0; i < ITERATIONS; i++) {
            ...
            // Use the dedicated client for WATCH/MULTI/EXEC
            // (On a shared multiplexed client this would fail under concurrency)
        ...
        double perCmdMs = perTxMs / 5.0; // 5 commands per tx
    ...
    public void testOCCConflictDetection() throws Exception {
        ...
        // Thread A: WATCH, read, sleep (giving Thread B time to modify), then MULTI/EXEC
        // Thread B: modify the key while Thread A is sleeping
