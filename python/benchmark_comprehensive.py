...
async def main():
    ...
    print(fmt("glide sync (FFI blocking)", glide_sync_set()))
    print(fmt("glide async (UDS+protobuf)", await glide_async_uds_set()))
    print(fmt("glide async (FFI callbacks) [NEW]", await glide_async_ffi_set()))

    print("\n=== GET benchmark ===")
    print(fmt("redis-py sync", redis_sync_get()))
    print(fmt("redis-py async", await redis_async_get()))
    print(fmt("glide sync (FFI blocking)", glide_sync_get()))
    print(fmt("glide async (UDS+protobuf)", await glide_async_uds_get()))
    print(fmt("glide async (FFI callbacks) [NEW]", await glide_async_ffi_get()))
